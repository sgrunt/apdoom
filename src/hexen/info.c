...
state_t states[NUMSTATES] = {
    ...
    // [crispy] disable full bright for Torch, use brightmap instead
    ...
    // [crispy] disable full bright for Boots of Speed, use brightmap instead
    {SPR_SPED, 0, 3, NULL, S_ARTI_BOOTS2, 0, 0},    // S_ARTI_BOOTS1
    {SPR_SPED, 1, 3, NULL, S_ARTI_BOOTS3, 0, 0},    // S_ARTI_BOOTS2
    {SPR_SPED, 2, 3, NULL, S_ARTI_BOOTS4, 0, 0},    // S_ARTI_BOOTS3
    {SPR_SPED, 3, 3, NULL, S_ARTI_BOOTS5, 0, 0},    // S_ARTI_BOOTS4
    {SPR_SPED, 4, 3, NULL, S_ARTI_BOOTS6, 0, 0},    // S_ARTI_BOOTS5
    {SPR_SPED, 5, 3, NULL, S_ARTI_BOOTS7, 0, 0},    // S_ARTI_BOOTS6
    {SPR_SPED, 6, 3, NULL, S_ARTI_BOOTS8, 0, 0},    // S_ARTI_BOOTS7
    {SPR_SPED, 7, 3, NULL, S_ARTI_BOOTS1, 0, 0},    // S_ARTI_BOOTS8
    // [crispy] disable full bright for Krater of Might, use brightmap instead
    {SPR_BMAN, 0, -1, NULL, S_NULL, 0, 0},  // S_ARTI_MANA
    // [crispy] disable full bright for Dragonskin Bracers, use brightmap instead
    {SPR_BRAC, 0, 4, NULL, S_ARTI_ARMOR2, 0, 0},    // S_ARTI_ARMOR1
    {SPR_BRAC, 1, 4, NULL, S_ARTI_ARMOR3, 0, 0},    // S_ARTI_ARMOR2
    {SPR_BRAC, 2, 4, NULL, S_ARTI_ARMOR4, 0, 0},    // S_ARTI_ARMOR3
    {SPR_BRAC, 3, 4, NULL, S_ARTI_ARMOR5, 0, 0},    // S_ARTI_ARMOR4
    {SPR_BRAC, 4, 4, NULL, S_ARTI_ARMOR6, 0, 0},    // S_ARTI_ARMOR5
    {SPR_BRAC, 5, 4, NULL, S_ARTI_ARMOR7, 0, 0},    // S_ARTI_ARMOR6
    {SPR_BRAC, 6, 4, NULL, S_ARTI_ARMOR8, 0, 0},    // S_ARTI_ARMOR7
    {SPR_BRAC, 7, 4, NULL, S_ARTI_ARMOR1, 0, 0},    // S_ARTI_ARMOR8
    ...
    // [crispy] disable full bright for Mystic Ambit Incant, use brightmap instead
    {SPR_HRAD, 0, 4, NULL, S_ARTI_HEALRAD2, 0, 0},  // S_ARTI_HEALRAD1
    {SPR_HRAD, 1, 4, NULL, S_ARTI_HEALRAD3, 0, 0},  // S_ARTI_HEALRAD2
    {SPR_HRAD, 2, 4, NULL, S_ARTI_HEALRAD4, 0, 0},  // S_ARTI_HEALRAD3
    {SPR_HRAD, 3, 4, NULL, S_ARTI_HEALRAD5, 0, 0},  // S_ARTI_HEALRAD4
    {SPR_HRAD, 4, 4, NULL, S_ARTI_HEALRAD6, 0, 0},  // S_ARTI_HEALRAD5
    {SPR_HRAD, 5, 4, NULL, S_ARTI_HEALRAD7, 0, 0},  // S_ARTI_HEALRAD6
    {SPR_HRAD, 6, 4, NULL, S_ARTI_HEALRAD8, 0, 0},  // S_ARTI_HEALRAD7
    {SPR_HRAD, 7, 4, NULL, S_ARTI_HEALRAD9, 0, 0},  // S_ARTI_HEALRAD8
    {SPR_HRAD, 8, 4, NULL, S_ARTI_HEALRAD0, 0, 0},  // S_ARTI_HEALRAD9
    {SPR_HRAD, 9, 4, NULL, S_ARTI_HEALRADA, 0, 0},  // S_ARTI_HEALRAD0
    {SPR_HRAD, 10, 4, NULL, S_ARTI_HEALRADB, 0, 0},  // S_ARTI_HEALRADA
    {SPR_HRAD, 11, 4, NULL, S_ARTI_HEALRADC, 0, 0},  // S_ARTI_HEALRADB
    {SPR_HRAD, 12, 4, NULL, S_ARTI_HEALRADD, 0, 0},  // S_ARTI_HEALRADC
    {SPR_HRAD, 13, 4, NULL, S_ARTI_HEALRADE, 0, 0},  // S_ARTI_HEALRADD
    {SPR_HRAD, 14, 4, NULL, S_ARTI_HEALRADF, 0, 0},  // S_ARTI_HEALRADE
    {SPR_HRAD, 15, 4, NULL, S_ARTI_HEALRAD1, 0, 0},  // S_ARTI_HEALRADF
    ...
    // [crispy] disable full bright for Fire Bull, use brightmap instead
    {SPR_FBUL, 0, 4, NULL, S_ZFIREBULL2, 0, 0},     // S_ZFIREBULL1
    {SPR_FBUL, 1, 4, NULL, S_ZFIREBULL3, 0, 0},     // S_ZFIREBULL2
    {SPR_FBUL, 2, 4, NULL, S_ZFIREBULL4, 0, 0},     // S_ZFIREBULL3
    {SPR_FBUL, 3, 4, NULL, S_ZFIREBULL5, 0, 0},     // S_ZFIREBULL4
    {SPR_FBUL, 4, 4, NULL, S_ZFIREBULL6, 0, 0},     // S_ZFIREBULL5
    {SPR_FBUL, 5, 4, NULL, S_ZFIREBULL7, 0, 0},     // S_ZFIREBULL6
    {SPR_FBUL, 6, 4, NULL, S_ZFIREBULL1, 0, 0},     // S_ZFIREBULL7
    {SPR_FBUL, 9, 4, NULL, S_ZFIREBULL_DEATH2, 0, 0},       // S_ZFIREBULL_DEATH
    {SPR_FBUL, 8, 4, NULL, S_ZFIREBULL_U, 0, 0},    // S_ZFIREBULL_DEATH2
    {SPR_FBUL, 7, -1, NULL, S_NULL, 0, 0},      // S_ZFIREBULL_U
    {SPR_FBUL, 8, 4, NULL, S_ZFIREBULL_BIRTH2, 0, 0},       // S_ZFIREBULL_BIRTH
    {SPR_FBUL, 9, 4, NULL, S_ZFIREBULL1, 0, 0},     // S_ZFIREBULL_BIRTH2
    ...
    {SPR_FSRD, 0, 1, A_WeaponReady, S_FSWORDREADY4, 0, 0},  // S_FSWORDREADY3
    {SPR_FSRD, 1, 1, A_WeaponReady, S_FSWORDREADY5, 0, 0},  // S_FSWORDREADY4
    {SPR_FSRD, 1, 1, A_WeaponReady, S_FSWORDREADY6, 0, 0},  // S_FSWORDREADY5
    {SPR_FSRD, 1, 1, A_WeaponReady, S_FSWORDREADY7, 0, 0},  // S_FSWORDREADY6
    {SPR_FSRD, 1, 1, A_WeaponReady, S_FSWORDREADY8, 0, 0},  // S_FSWORDREADY7
    {SPR_FSRD, 2, 1, A_WeaponReady, S_FSWORDREADY9, 0, 0},  // S_FSWORDREADY8
    ...
    {SPR_FSRD, 6, 3, A_FSwordAttack, S_FSWORDATK_5, 5, 36}, // S_FSWORDATK_4
    {SPR_FSRD, 7, 2, NULL, S_FSWORDATK_6, 5, 36},   // S_FSWORDATK_5
    {SPR_FSRD, 8, 2, NULL, S_FSWORDATK_7, 5, 36},   // S_FSWORDATK_6
    {SPR_FSRD, 8, 10, NULL, S_FSWORDATK_8, 5, 150}, // S_FSWORDATK_7
    {SPR_FSRD, 0, 1, NULL, S_FSWORDATK_9, 5, 60},   // S_FSWORDATK_8
    {SPR_FSRD, 1, 1, NULL, S_FSWORDATK_10, 5, 55},  // S_FSWORDATK_9
    ...
    // [crispy] disable full bright for Arc of Death, use brightmap instead
    {SPR_MLNG, 0, 1, A_WeaponReady, S_MLIGHTNINGREADY2, 0, 0},      // S_MLIGHTNINGREADY
    {SPR_MLNG, 0, 1, A_WeaponReady, S_MLIGHTNINGREADY3, 0, 0},      // S_MLIGHTNINGREADY2
    {SPR_MLNG, 0, 1, A_WeaponReady, S_MLIGHTNINGREADY4, 0, 0},      // S_MLIGHTNINGREADY3
    {SPR_MLNG, 0, 1, A_WeaponReady, S_MLIGHTNINGREADY5, 0, 0},      // S_MLIGHTNINGREADY4
    {SPR_MLNG, 0, 1, A_WeaponReady, S_MLIGHTNINGREADY6, 0, 0},      // S_MLIGHTNINGREADY5
    {SPR_MLNG, 0, 1, A_LightningReady, S_MLIGHTNINGREADY7, 0, 0},   // S_MLIGHTNINGREADY6
    {SPR_MLNG, 1, 1, A_WeaponReady, S_MLIGHTNINGREADY8, 0, 0},      // S_MLIGHTNINGREADY7
    {SPR_MLNG, 1, 1, A_WeaponReady, S_MLIGHTNINGREADY9, 0, 0},      // S_MLIGHTNINGREADY8
    {SPR_MLNG, 1, 1, A_WeaponReady, S_MLIGHTNINGREADY10, 0, 0},     // S_MLIGHTNINGREADY9
    {SPR_MLNG, 1, 1, A_WeaponReady, S_MLIGHTNINGREADY11, 0, 0},     // S_MLIGHTNINGREADY10
    {SPR_MLNG, 1, 1, A_WeaponReady, S_MLIGHTNINGREADY12, 0, 0},     // S_MLIGHTNINGREADY11
    {SPR_MLNG, 1, 1, A_WeaponReady, S_MLIGHTNINGREADY13, 0, 0},     // S_MLIGHTNINGREADY12
    {SPR_MLNG, 2, 1, A_WeaponReady, S_MLIGHTNINGREADY14, 0, 0},     // S_MLIGHTNINGREADY13
    {SPR_MLNG, 2, 1, A_WeaponReady, S_MLIGHTNINGREADY15, 0, 0},     // S_MLIGHTNINGREADY14
    {SPR_MLNG, 2, 1, A_WeaponReady, S_MLIGHTNINGREADY16, 0, 0},     // S_MLIGHTNINGREADY15
    {SPR_MLNG, 2, 1, A_WeaponReady, S_MLIGHTNINGREADY17, 0, 0},     // S_MLIGHTNINGREADY16
    {SPR_MLNG, 2, 1, A_WeaponReady, S_MLIGHTNINGREADY18, 0, 0},     // S_MLIGHTNINGREADY17
    {SPR_MLNG, 2, 1, A_LightningReady, S_MLIGHTNINGREADY19, 0, 0},  // S_MLIGHTNINGREADY18
    {SPR_MLNG, 1, 1, A_WeaponReady, S_MLIGHTNINGREADY20, 0, 0},     // S_MLIGHTNINGREADY19
    {SPR_MLNG, 1, 1, A_WeaponReady, S_MLIGHTNINGREADY21, 0, 0},     // S_MLIGHTNINGREADY20
    {SPR_MLNG, 1, 1, A_WeaponReady, S_MLIGHTNINGREADY22, 0, 0},     // S_MLIGHTNINGREADY21
    {SPR_MLNG, 1, 1, A_WeaponReady, S_MLIGHTNINGREADY23, 0, 0},     // S_MLIGHTNINGREADY22
    {SPR_MLNG, 1, 1, A_WeaponReady, S_MLIGHTNINGREADY24, 0, 0},     // S_MLIGHTNINGREADY23
    {SPR_MLNG, 1, 1, A_WeaponReady, S_MLIGHTNINGREADY, 0, 0},       // S_MLIGHTNINGREADY24
    {SPR_MLNG, 0, 1, A_Lower, S_MLIGHTNINGDOWN, 0, 0},      // S_MLIGHTNINGDOWN
    {SPR_MLNG, 0, 1, A_Raise, S_MLIGHTNINGUP, 0, 0},        // S_MLIGHTNINGUP
    {SPR_MLNG, 3, 3, NULL, S_MLIGHTNINGATK_2, 0, 0},        // S_MLIGHTNINGATK_1
    {SPR_MLNG, 4, 3, NULL, S_MLIGHTNINGATK_3, 0, 0},        // S_MLIGHTNINGATK_2
    {SPR_MLNG, 5, 4, A_MLightningAttack, S_MLIGHTNINGATK_4, 0, 0},  // S_MLIGHTNINGATK_3
    {SPR_MLNG, 6, 4, NULL, S_MLIGHTNINGATK_5, 0, 0},        // S_MLIGHTNINGATK_4
    {SPR_MLNG, 7, 3, NULL, S_MLIGHTNINGATK_6, 0, 0},        // S_MLIGHTNINGATK_5
    {SPR_MLNG, 8, 3, NULL, S_MLIGHTNINGATK_7, 0, 0},        // S_MLIGHTNINGATK_6
    {SPR_MLNG, 8, 6, NULL, S_MLIGHTNINGATK_8, 0, 199},      // S_MLIGHTNINGATK_7
    {SPR_MLNG, 2, 2, NULL, S_MLIGHTNINGATK_9, 0, 55},       // S_MLIGHTNINGATK_8
    {SPR_MLNG, 1, 2, NULL, S_MLIGHTNINGATK_10, 0, 50},      // S_MLIGHTNINGATK_9
    {SPR_MLNG, 1, 2, NULL, S_MLIGHTNINGATK_11, 0, 45},      // S_MLIGHTNINGATK_10
    {SPR_MLNG, 1, 2, NULL, S_MLIGHTNINGREADY, 0, 40},       // S_MLIGHTNINGATK_11
	...
	{SPR_LVST,32768,175,NULL,S_LVSTB,0,0}, // S_LVSTT
