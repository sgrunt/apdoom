...
static const char* heretic_level_names[HERETIC_EP_COUNT][MAP_COUNT] = {
    {
        "The Docks (E1M1)",
        "The Dungeons (E1M2)",
        "The Gatehouse (E1M3)",
    ...
    // There are 3 extra secret levels. Lets see about them later when we understand this better (They have no names)
    //E6M1	Secret Level
    //E6M2	Secret Level
    //E6M3*	Secret Level
};
...
extern map_t heretic_maps[HERETIC_EP_COUNT][MAP_COUNT];
